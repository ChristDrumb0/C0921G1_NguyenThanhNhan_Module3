            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form class="col-lg-8 col-12" method="post">
                        ...
                        <div class="form-group col-12">
                            <label class="col-12 float-left" for="exampleInput5">Room standard:</label>
                            <input type="text" name="standard" class="form-control col-12  mt-2"
                                   id="exampleInput5" placeholder="Enter standard" value="${house.standard}" required="required">
                            <p style="color: red"> ${msgIdCard} </p>
                        </div>
                        <div class="form-group col-12">
                        ...
                        <div class="form-group col-12">
                            <label class="col-12 float-left" for="exampleInput8">Pool Area:</label>
                            <input type="text" name="pool_area" class="form-control col-12  mt-2"
                                   id="exampleInput8" placeholder="Enter pool area" value="${house.poolArea}" required="required">
                            <p style="color: red"> ${msgIdCard} </p>
                        </div>
                        <div class="form-group col-12">
                            <label class="col-12 float-left" for="exampleInput7">Storey:</label>
                            <input type="text" name="storey" class="form-control col-12  mt-2"
                                   id="exampleInput7" placeholder="Enter storey" value="${house.storey}" required="required">
                            <p style="color: red"> ${msgIdCard} </p>
                        </div>
