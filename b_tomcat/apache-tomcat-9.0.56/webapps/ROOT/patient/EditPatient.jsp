                ...
                <div class="row">
                    ...
                    <form class="col-lg-8 col-12" method="post">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="button" class="btn btn-dark " data-bs-toggle="modal" data-bs-target="#exampleModal">Back</button>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        you haven't Edit yet, do you want to return?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No
                                        </button>
                                        <a href="/patient" class="btn btn-primary">Yes </a>
                                    </div>
                                </div>
                            </div>
                        </div>
