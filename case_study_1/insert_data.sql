...
insert into furama_management.vi_tri(ten_vi_tri)
value 
(
'nhân viên'
);
UPDATE furama_management.vi_tri
SET ten_vi_tri = 'nhân viên'
where ma_vi_tri = 2;

-- insert trinh do
SELECT * FROM furama_management.trinh_do;
insert into furama_management.trinh_do
value 
(1,'Trung Cấp'),
(2,'Cao Đẳng'),
(3,'Đại Học'),
...
insert into furama_management.nhan_vien
...
insert into furama_management.loai_khach
value(1,'Diamond'),
(2,'Platinium'),
(3,'Gold'),
(4,'Silver'),
...
insert into furama_management.loai_dich_vu
value
(1,'Villa'),
(2,'House'),
(3,'Room');
...
insert into furama_management.kieu_thue
value(1,'year'),
(2,'month'),
(3,'day'),
(4,'hour');
...
insert into furama_management.khach_hang
value (1,'Nguyễn Thị Hào','1970-11-07',b'0','643431213','0945423362','thihao07@gmail.com','23 Nguyễn Hoàng, Đà Nẵng',5),
...
insert into furama_management.hop_dong_chi_tiet
value
(1,5,2,4),
(2,8,2,5),
(3,15,2,6),
...
insert into furama_management.hop_dong
value
...
insert into furama_management.dich_vu_di_kem
value
...
insert into furama_management.dich_vu
value
...
insert into furama_management.bo_phan
value 
(1,'Sale-Marketing'),
(2,'Hành chính'),
(3,'Phục vụ'),
