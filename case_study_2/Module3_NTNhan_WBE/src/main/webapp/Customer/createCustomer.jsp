                ...
                <div class="row">
                    ...
                    <form class="col-lg-8 col-12" method="post">
                        ...
                        <div class="form-group col-12">
                            <label class="col-12 float-left" for="exampleInput1">Customer's Name:</label>
                            <input type="text" name="name" class="form-control col-12 mt-2"
                                   id="exampleInput1" placeholder="Enter full name" value="${customer.name}" required="required">
                        </div>
                        <div class="form-group col-12">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="address" class="form-control col-12  mt-2"
                                   id="exampleInput8" placeholder="Enter address" value="${customer.address}" required="required">
                            <p style="color: red"> ${msgIdCard} </p>
                        </div>
                        <div class="form-group col-12">
                            <label class="col-12 float-left mt-1" for="exampleInputCustomerType">CustomerType:</label>
                            <select name="customerType" id="exampleInputCustomerType" class="form-control col-12" required="required">
